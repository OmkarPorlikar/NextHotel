...
const FloatingContactIcons = () => {
  ...
  const email = 'contact@hotelsunshine.com';
  ...
  return (
    <div className="fixed right-5 bottom-5 flex flex-col gap-4 z-50">
      ...
      <a
        ...
        className="w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-br from-[#B8860B] to-[#DAA520] shadow-lg"
        title="Call Us"
      >

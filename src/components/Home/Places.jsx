      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <footer className="text-center mt-12 sm:mt-16">
            <Link
              href="/pauni-tourism"
              className={`inline-flex items-center text-white/70 hover:text-[#DAA520] transform transition-all duration-500 group focus:outline-none focus:ring-2 focus:ring-[#DAA520] focus:ring-offset-2 focus:ring-offset-[#0e1529] rounded-lg px-4 py-2 will-change-transform ${isVisible
                  ? 'opacity-100 translate-y-0'
                  : 'opacity-0 translate-y-8'
                }`}
              style={{ transitionDelay: '600ms' }}
              aria-label="Explore all tourist destinations in Pauni"
            >
              <span className="text-sm sm:text-base font-light tracking-wider">
                Explore All Pauni Attractions
              </span>
              <svg
